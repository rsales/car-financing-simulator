			...
			<div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-32 sm:pb-40">
				<div>
					...
					<div>
						...
						<p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Somos o seu simulador de financimento online para seu futuro carro. Simule agora o seu futuro financiamento do seu automóvel de forma totalmente online e grátis.</p>
