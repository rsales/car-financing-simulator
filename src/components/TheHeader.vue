    ...
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-32 sm:pb-40">
        <div>
          ...
          <div>
            <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Simulador de Financiamento de Veículos, simulação online</h1>
          ...
          <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-45rem)]">
