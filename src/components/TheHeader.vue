		...
		<div>
            ...
            Simula Car
				...
				<!-- <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
					<a href="#" class="font-semibold text-gray-900 hover:text-gray-900">Simulador automotivo</a>
					<a href="#" class="font-semibold text-gray-900 hover:text-gray-900">Simulador Imobiliario</a>
				</div> -->
	...
	<main>
		<div class="relative px-6 lg:px-8">
          ...
          <img class="w-96 mt-5 mx-auto" src="../assets/new_car_3d.png" alt="">
					...
					<div>
						<h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Simulador de Financiamento de Veículos Online</h1>
						<p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Somos o seu simulador de financimento online. Venha e teste com a gente o seu futuro financiamento automotivo de forma totalmente online e grátis.</p>
						<div class="mt-8 flex gap-x-4 sm:justify-center">
							<a href="#form" class="inline-block rounded-lg bg-indigo-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700">
								Simular agora
					...
					<div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden hidden blur-3xl sm:top-[calc(100%-45rem)] sm:block">
